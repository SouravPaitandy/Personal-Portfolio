        ...
        <div className="skills flex flex-col gap-3">
          ...
          className="tech-lists flex flex-wrap gap-3">
            <div className="tooltip-container">
              ...
              <span className="text ">
                <img
                  src={import.meta.env.BASE_URL + "/src/assets/skills3.png"}
                  alt="Javascript"
            ...
            <div className="tooltip-container">
              ...
              <span className="text ">
                <img
                  src={import.meta.env.BASE_URL + "/src/assets/skills12.png"}
                  alt="Node.js"
                  className="project-img"
                />
              </span>
            ...
            <div className="tooltip-container">
              ...
              <span className="text ">
                <img
                  src={import.meta.env.BASE_URL + "/src/assets/skills13.png"}
                  alt="Express"
                  className="project-img"
                />
              </span>
            ...
            <div className="tooltip-container">
              ...
              <span className="text ">
                <img
                  src={import.meta.env.BASE_URL + "/src/assets/mDB.ico"}
                  alt="MongoDB"
                  className="project-img"
                />
              </span>
            ...
            <div className="tooltip-container">
              ...
              <span className="text ">
                <img
                  src={import.meta.env.BASE_URL + "/src/assets/skills9.png"}
                  alt="React"
                  className="project-img"
                />
              </span>
            ...
            <div className="tooltip-container">
              ...
              <span className="text ">
              <img
                  src={import.meta.env.BASE_URL + "/src/assets/skills11.png"}
                  alt="Next.js"
            ...
            <div className="tooltip-container">
              ...
              <span className="text ">
                <img
                  src={import.meta.env.BASE_URL + "/src/assets/skills14.png"}
                  alt="SQL"
                  className="project-img"
                />
              </span>
            ...
            <div className="tooltip-container">
              ...
              <span className="text ">
                <img
                  src={import.meta.env.BASE_URL + "/src/assets/skills1.png"}
                  alt="HTML5"
                  className="project-img"
                />
              </span>
            ...
            <div className="tooltip-container">
              ...
              <span className="text ">
                <img
                  src={import.meta.env.BASE_URL + "/src/assets/skills2.png"}
                  alt="CSS3"
                  className="project-img"
                />
              </span>
            ...
            <div className="tooltip-container">
              ...
              <span className="text ">
                <img
                  src={import.meta.env.BASE_URL + "/src/assets/skills10.png"}
                  alt="Redux"
                  className="project-img"
                />
              </span>
            ...
            <div className="tooltip-container">
              ...
              <span className="text ">
                <img
                  src={import.meta.env.BASE_URL + "/src/assets/skills4.png"}
                  alt="Bootstrap"
                  className="project-img"
                />
              </span>
            ...
            <div className="tooltip-container">
              ...
              <span className="text ">
                <img
                  src={import.meta.env.BASE_URL + "/src/assets/skills5.png"}
                  alt="Tailwind"
                  className="project-img"
                />
              </span>
